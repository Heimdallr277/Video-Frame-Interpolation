...
model_arg.add_argument('--model', type=str, default='VFI')
model_arg.add_argument('--attention', action='store_true')
...
learn_arg.add_argument('--val_batch_size', type=int, default=8)
